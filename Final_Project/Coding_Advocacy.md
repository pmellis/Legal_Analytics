...
The following paper attempts to introduce new approaches to analyze the United States' Supreme Court's rich tradition of oral argument, and suggest ways these methods could be further developed to forecast Supreme Court case outcomes, and potentially, case assessment and prediction in lower courts. These techniques are certainly not new or even very advanced in the world of data science and analytics, but they are rarely applied to a field and profession that needs them perhaps more than ever. 
