...
This information, standing alone, does not have tremendous value. However, when combined with other information or further analyzed, this information may provide insight into the attitudes and understandings of the justices. Again, this is merely a starting place, but an excellent example of using R to automate and dissect information that would otherwise be extremely difficult to grasp or quantify with armchair theory alone. 
